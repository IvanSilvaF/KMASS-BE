def includeme(config):  # pylint: disable=too-many-statements
    ...
    config.add_route("api.upload",
        "/api/{username}/upload",
        factory="h.traversal.UserByNameRoot",
        traverse="/{username}",
    )

    config.add_route("api.delete",
        "/api/{username}/delete",
        request_method="POST",
        factory="h.traversal.UserByNameRoot",
        traverse="/{username}",
    ...
    # TEST IVAN
    config.add_route("test.test","/test")

    # Admin
    config.add_route("admin.index", "/admin/")
    config.add_route("admin.upload", "/admin/upload")
