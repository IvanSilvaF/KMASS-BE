...
class DocumentBucket:
    # document: h.models.document._document:Document
...
class Timeframe:
    ...
    def append(self, annotation):
        ...
        param: annotation - h.models.annotation
        """
    ...
    def add(self, document):
        document_bucket = self.document_buckets.get(document)

        if document_bucket is None:
            document_bucket = DocumentBucket(document)
            self.document_buckets[document] = document_bucket
